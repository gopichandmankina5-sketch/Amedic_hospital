...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull TextInputEditText emailInput,
      ...
      @NonNull ProgressBar progressBar, @NonNull TextView registerRedirect) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ScrollView) rootView, emailInput, emailInputLayout,
          loginButton, passwordInput, passwordInputLayout, progressBar, registerRedirect);
    }
