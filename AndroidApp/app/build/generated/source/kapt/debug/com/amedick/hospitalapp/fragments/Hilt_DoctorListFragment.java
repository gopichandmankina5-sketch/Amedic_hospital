...
public abstract class Hilt_DoctorListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DoctorListFragment() {
    super();
  }

  Hilt_DoctorListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DoctorListFragment_GeneratedInjector) this.generatedComponent()).injectDoctorListFragment(UnsafeCasts.<DoctorListFragment>unsafeCast(this));
    }
  }
