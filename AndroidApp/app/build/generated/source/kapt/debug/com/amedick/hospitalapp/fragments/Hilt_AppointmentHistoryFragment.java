...
public abstract class Hilt_AppointmentHistoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppointmentHistoryFragment() {
    super();
  }

  Hilt_AppointmentHistoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppointmentHistoryFragment_GeneratedInjector) this.generatedComponent()).injectAppointmentHistoryFragment(UnsafeCasts.<AppointmentHistoryFragment>unsafeCast(this));
    }
  }
